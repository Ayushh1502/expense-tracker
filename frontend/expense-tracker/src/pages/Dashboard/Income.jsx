...
const Income = () => {
    ...
    const handleAddIncome = async (income) => {
        ...
        try {
            ...
            console.log("Something went wrong while adding income" , error.response?.data?.message || error.message);
        }
    }
    ...
    const deleteIncome = async (id) => {
        try {
            ...
            console.log("Something went wrong while deleting income" , 
    ...
    const handleDownloadIncomeDetails = async () => {
        try {
            ...
            console.log("Something went wrong while downloading income" , err);
